...
require_once 'includes/ClassEntity.php';
        ...
        switch ($_POST['action']) {
            case 'add':
                try {
                    ...
                    $class->setName(trim($_POST['name']));
                    $class->setGradeLevel(trim($_POST['grade_level']));
                    $class->setAcademicYear(trim($_POST['academic_year']));
                    $class->setTeacherId($_POST['teacher_id'] ?: null);
                    ...
                    header('Location: classes.php?error=' . urlencode($e->getMessage()));
                    exit();
                }
                break;
            ...
            case 'delete':
                ...
                try {
                    ...
                    header('Location: classes.php?error=Failed to delete class');
                    exit();
                }
                break;
        }
            ...
            <div class="col-md-9 col-lg-10">
                <div class="p-4">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <h2><i class="fas fa-chalkboard"></i> Manage Classes</h2>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h5 class="mb-0"><i class="fas fa-list"></i> All Classes</h5>
                        </div>
                        <div class="card-body">
